...
<div id="Catalog">
  <h2>최종 추천 분석 중...</h2>
  <p>Local LLM (Ollama llama3.1:8b)이 게임 결과와 라이프스타일을 분석하여 최적의 품종을 추천하고 있습니다.</p>
...
function pollLogStatus() {
  ...
  xhr.open('GET', '${pageContext.request.contextPath}/actions/FinalRecommendation.action?getLogStatus=', true);
    ...
    if (xhr.readyState === 4 && xhr.status === 200) {
      try {
        ...
        if (response.status === 'done') {
          ...
          // 결과 페이지로 이동
          window.location.href = '${pageContext.request.contextPath}/actions/FinalRecommendation.action?getResult=';
